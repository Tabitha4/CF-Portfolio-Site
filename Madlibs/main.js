...
var form = document.getElementById("mainForm");
  ...
  function createMadLib() {
    ...
    var madlib = `A coffee is much needed when you wake up <strong> ${adjective1}</strong> with your <strong> ${adjective2} </strong> fuzzy brain. Usually, you go to some place
    that is a/an cozy <strong> ${noun1} </strong> or a/an familiar <strong> ${noun2} </strong> spot.
